    ...
    >
      ...
      <Transition name="slide-fade"
        ...
        >
          ...
          <div class="ml-3 text-sm font-normal">
            Tweet anxiety detection successful.
          </div>
          <button
            type="button"
            class="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700"
      ...
      <div class="border-t border-gray-200 dark:border-none">
        <section class="dark:bg-gray-800">
          <div class="container px-6 py-12 mx-auto">
            <div class="lg:max-w-xl mx-auto">
              ...
              >
                Feeling anxious?<br />Detect the anxiety from your Tweets!
              </h1>
              ...
              <div
                class="flex p-4 my-5 mb-4 text-sm text-blue-700 bg-blue-100 rounded-lg shadow dark:text-white dark:bg-blue-600"
                role="alert"
              >
                <svg
              ...
              <div class="w-full mt-6">
                <textarea
                  ...
                  class="resize-none block w-full h-40 px-4 py-2 text-gray-600 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"
                />
                <span
          ...
          <div class="container px-6 py-12 mx-auto">
            <div class="lg:max-w-xl mx-auto">
              <div class="flex flex-col items-center space-y-3">
                ...
                <div
                  class="flex w-full lg:max-w-xl p-4 my-5 mb-4 text-sm text-blue-700 bg-blue-100 rounded-lg shadow dark:text-white dark:bg-blue-600"
                  role="alert"
                >
                  <svg
                    class="inline flex-shrink-0 mr-3 w-5 h-5"
                ...
                >
                  ...
                  <p
                    class="font-normal text-gray-700 dark:text-white opacity-20"
                  >
                    Please wait
                  </p>
        ...
        <section class="dark:bg-gray-800">
          <div class="container px-6 py-12 mx-auto">
            <div class="lg:max-w-xl mx-auto">
              <div
                class="flex flex-col items-center space-y-3 text-center dark:bg-gray-800"
              >
                <span
                  class="inline-block p-3 text-blue-500 bg-blue-100 rounded-full dark:text-white dark:bg-blue-600"
                >
                ...
                <div
                  class="flex justify-center w-full lg:max-w-xl mt-10 p-5 rounded-lg border border-gray-200 shadow dark:bg-white dark:border-gray-700"
                >
                  <nuxt-img
                    format="webp"
                    class="rounded-md"
...
const fastAPI = (e) => {
  ...
  if (prompt.value === "") {
    ...
    fetch(config.public.apiURL, {
      ...
      headers: {
        Origin: "https://tweets-anxiety-detector.vercel.app/",
